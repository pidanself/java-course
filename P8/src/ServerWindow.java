...
public class ServerWindow{
	  public ServerWindow(String name,String ids,String sexs,String gls,String majors,String addresss) {
	    ...
	    panel.add(iplabel);
  	    ...
  	    JButton buttonlogin = bwp.DrawButton(95, 290, 230, 30, buttoncolor, font, "接收");
	  ...
	  public static void main(String[] args){
		  ServerWindow ll =new ServerWindow(null, null, null, null, null, null);
